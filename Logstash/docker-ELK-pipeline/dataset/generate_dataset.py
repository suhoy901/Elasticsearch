...
def setup_index():
    ...
    for i in range(1, n+1):
        ...
        # 고객의 성별
        gender = random.choices(['남성', '여성'], weights=[0.4, 0.6], k=1)[0]
        ...
        city = random.choices(
            ["서울특별시", "경상남도", "경상북도", "전라남도", "전라북도", "충청남도", "충청북도", "세종특별자치시", "강원도",
                "경기도", "울산광역시", "대전광역시", "광주광역시", "인천광역시", "대구광역시", "부산광역시", "제주특별자치도"],
        ...
        date = datetime.datetime(
            ...
            random.choices(range(1, 8), weights=[
                           0.2, 0.1, 0.05, 0.05, 0.07, 0.03, 0.02], k=1)[0],
